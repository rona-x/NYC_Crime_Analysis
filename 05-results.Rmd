...
```
### Distributions of Crime Events in Different Time Ranges
...
ggparcoord(dv36,columns = 2:25,groupColumn = "County",scale = "globalminmax")+
  ...
  scale_color_manual(name = "County", labels =c("Brooklyn","Bronx","Manhattan","Queens","Staten Island"),values = c("#ef476f","#ffd166","#06d6a0","#118ab2","#073b4c"))+
  labs(x = "Time",y= " Count", title = "The Number of Crime Events in Different Time Ranges")
```
